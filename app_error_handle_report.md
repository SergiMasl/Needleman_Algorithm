...
| `GridBuild` methods other than `matrix_construct` raising runtime errors | Propagate uncaught to `main.py` top-level guard; error messages may be less descriptive |